...
#include "ros/ros.h"
#include "std_msgs/String.h" // µ¼ÈëÏûÏ¢ÀàÐÍÍ·ÎÄ¼þ
#include "dynamic_reconfigure/server.h"
#include "apb_controllers/VehiclePropertiesConfig.h"
#include "boost/thread/mutex.hpp"
#include "apb_msgs/ThrustStamped.h"
#include "apb_msgs/Imu.h"
#include "apb_msgs/NetLoad.h"
#include "apb_msgs/DepthTemp.h"
...
class ThrusterController{
    private:
        ...
        apb_msgs::ThrustStamped thrust_msg;
        geometry_msgs::Vector3Stamped cob_msg;

        //Dynamic Reconfigure Setup
        typedef dynamic_reconfigure::Server<apb_controllers::VehiclePropertiesConfig> DynamicReconfigServer;
        ...
        double solver_forces[6];   //Solved forces go here
    ...
    public:
        ...
        void InitThrustMsg();
        void DynamicReconfigCallback(apb_controllers::VehiclePropertiesConfig &config, uint32_t levels);
        void ImuCB(const apb_msgs::Imu::ConstPtr &imu_msg);
        void NetLoadCB(const apb_msgs::NetLoad::ConstPtr &load_msg);
        void DepthCB(const apb_msgs::DepthTemp::ConstPtr &depth_msg);
        void Loop();
};
